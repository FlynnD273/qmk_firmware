...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_FNR] = LAYOUT_60_ansi(
        ...
        KC_LCTL, XXXXXXX, KC_LALT,                          XXXXXXX,                            KC_RALT,   KC_LGUI,       _______, KC_RCTL
        ),
    ...
    [L_NUM] = LAYOUT_60_ansi(
        ...
        XXXXXXX, MO(L_FNL), XXXXXXX,                          XXXXXXX,                                                    KC_P0,  KC_DOT,   TO(L_DEF),  XXXXXXX
        ),

    [L_FNL] = LAYOUT_60_ansi(
        KC_GRV,   KC_F1,    KC_F2,      KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,    KC_F11,    KC_F12,      KC_DEL,
        XXXXXXX,    XXXXXXX,  XXXXXXX,    XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_HOME,  XXXXXXX,  KC_END,   KC_PSCR,   XXXXXXX,   XXXXXXX,  XXXXXXX,
